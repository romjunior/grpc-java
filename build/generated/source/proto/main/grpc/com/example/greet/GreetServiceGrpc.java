...
public final class GreetServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.greet.GreetRequest,
      com.example.greet.GreetResponse> getGreetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Greet",
      requestType = com.example.greet.GreetRequest.class,
      responseType = com.example.greet.GreetResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.greet.GreetRequest,
      com.example.greet.GreetResponse> getGreetMethod() {
    io.grpc.MethodDescriptor<com.example.greet.GreetRequest, com.example.greet.GreetResponse> getGreetMethod;
      ...
      synchronized (GreetServiceGrpc.class) {
        if ((getGreetMethod = GreetServiceGrpc.getGreetMethod) == null) {
          GreetServiceGrpc.getGreetMethod = getGreetMethod =
              io.grpc.MethodDescriptor.<com.example.greet.GreetRequest, com.example.greet.GreetResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Greet"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.greet.GreetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.greet.GreetResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.greet.GreetRequest,
      com.example.greet.GreetResponse> getGreetManyTimesMethod;
  ...
  public static io.grpc.MethodDescriptor<com.example.greet.GreetRequest,
      com.example.greet.GreetResponse> getGreetManyTimesMethod() {
    io.grpc.MethodDescriptor<com.example.greet.GreetRequest, com.example.greet.GreetResponse> getGreetManyTimesMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.greet.GreetRequest,
      com.example.greet.GreetResponse> getLongGreetMethod;
  ...
  public static io.grpc.MethodDescriptor<com.example.greet.GreetRequest,
      com.example.greet.GreetResponse> getLongGreetMethod() {
    io.grpc.MethodDescriptor<com.example.greet.GreetRequest, com.example.greet.GreetResponse> getLongGreetMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.greet.GreetRequest,
      com.example.greet.GreetResponse> getGreetEveryoneMethod;
  ...
  public static io.grpc.MethodDescriptor<com.example.greet.GreetRequest,
      com.example.greet.GreetResponse> getGreetEveryoneMethod() {
    io.grpc.MethodDescriptor<com.example.greet.GreetRequest, com.example.greet.GreetResponse> getGreetEveryoneMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.greet.GreetRequest,
      com.example.greet.GreetResponse> getGreetWithDeadlineMethod;
  ...
  public static io.grpc.MethodDescriptor<com.example.greet.GreetRequest,
      com.example.greet.GreetResponse> getGreetWithDeadlineMethod() {
    io.grpc.MethodDescriptor<com.example.greet.GreetRequest, com.example.greet.GreetResponse> getGreetWithDeadlineMethod;
  ...
  public static abstract class GreetServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void greet(com.example.greet.GreetRequest request,
        io.grpc.stub.StreamObserver<com.example.greet.GreetResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGreetMethod(), responseObserver);
    }

    /**
     */
    public void greetManyTimes(com.example.greet.GreetRequest request,
        io.grpc.stub.StreamObserver<com.example.greet.GreetResponse> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.example.greet.GreetRequest> longGreet(
        io.grpc.stub.StreamObserver<com.example.greet.GreetResponse> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.example.greet.GreetRequest> greetEveryone(
        io.grpc.stub.StreamObserver<com.example.greet.GreetResponse> responseObserver) {
    ...
    /**
     */
    public void greetWithDeadline(com.example.greet.GreetRequest request,
        io.grpc.stub.StreamObserver<com.example.greet.GreetResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.example.greet.GreetRequest,
                com.example.greet.GreetResponse>(
                  this, METHODID_GREET)))
          .addMethod(
  ...
  public static final class GreetServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreetServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.example.greet.GreetResponse greet(com.example.greet.GreetRequest request) {
    ...
    /**
     */
    public java.util.Iterator<com.example.greet.GreetResponse> greetManyTimes(
        com.example.greet.GreetRequest request) {
    ...
    /**
     */
    public com.example.greet.GreetResponse greetWithDeadline(com.example.greet.GreetRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class GreetServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GreetServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.greet.GreetResponse> greet(
        com.example.greet.GreetRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.greet.GreetResponse> greetWithDeadline(
        com.example.greet.GreetRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREET:
          serviceImpl.greet((com.example.greet.GreetRequest) request,
              (io.grpc.stub.StreamObserver<com.example.greet.GreetResponse>) responseObserver);
          break;
        case METHODID_GREET_MANY_TIMES:
          serviceImpl.greetManyTimes((com.example.greet.GreetRequest) request,
              (io.grpc.stub.StreamObserver<com.example.greet.GreetResponse>) responseObserver);
          break;
        case METHODID_GREET_WITH_DEADLINE:
          serviceImpl.greetWithDeadline((com.example.greet.GreetRequest) request,
              (io.grpc.stub.StreamObserver<com.example.greet.GreetResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.greet.Greet.getDescriptor();
    }
