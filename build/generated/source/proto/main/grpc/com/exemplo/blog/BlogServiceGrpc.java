...
public final class BlogServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.exemplo.blog.Blog,
      com.exemplo.blog.Blog> getCreateBlogMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateBlog",
      requestType = com.exemplo.blog.Blog.class,
      responseType = com.exemplo.blog.Blog.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.exemplo.blog.Blog,
      com.exemplo.blog.Blog> getCreateBlogMethod() {
    io.grpc.MethodDescriptor<com.exemplo.blog.Blog, com.exemplo.blog.Blog> getCreateBlogMethod;
      ...
      synchronized (BlogServiceGrpc.class) {
        if ((getCreateBlogMethod = BlogServiceGrpc.getCreateBlogMethod) == null) {
          BlogServiceGrpc.getCreateBlogMethod = getCreateBlogMethod =
              io.grpc.MethodDescriptor.<com.exemplo.blog.Blog, com.exemplo.blog.Blog>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateBlog"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.exemplo.blog.Blog.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.exemplo.blog.ReadBlogRequest,
      com.exemplo.blog.Blog> getReadBlogMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ReadBlog",
      requestType = com.exemplo.blog.ReadBlogRequest.class,
      responseType = com.exemplo.blog.Blog.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.exemplo.blog.ReadBlogRequest,
      com.exemplo.blog.Blog> getReadBlogMethod() {
    io.grpc.MethodDescriptor<com.exemplo.blog.ReadBlogRequest, com.exemplo.blog.Blog> getReadBlogMethod;
    if ((getReadBlogMethod = BlogServiceGrpc.getReadBlogMethod) == null) {
      synchronized (BlogServiceGrpc.class) {
        if ((getReadBlogMethod = BlogServiceGrpc.getReadBlogMethod) == null) {
          BlogServiceGrpc.getReadBlogMethod = getReadBlogMethod =
              io.grpc.MethodDescriptor.<com.exemplo.blog.ReadBlogRequest, com.exemplo.blog.Blog>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ReadBlog"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.exemplo.blog.ReadBlogRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.exemplo.blog.Blog.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.exemplo.blog.Blog,
      com.exemplo.blog.Blog> getUpdateBlogMethod;
  ...
  public static io.grpc.MethodDescriptor<com.exemplo.blog.Blog,
      com.exemplo.blog.Blog> getUpdateBlogMethod() {
    io.grpc.MethodDescriptor<com.exemplo.blog.Blog, com.exemplo.blog.Blog> getUpdateBlogMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.exemplo.blog.DeleteBlogEntity,
      com.exemplo.blog.DeleteBlogEntity> getDeleteBlogMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "DeleteBlog",
      requestType = com.exemplo.blog.DeleteBlogEntity.class,
      responseType = com.exemplo.blog.DeleteBlogEntity.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.exemplo.blog.DeleteBlogEntity,
      com.exemplo.blog.DeleteBlogEntity> getDeleteBlogMethod() {
    io.grpc.MethodDescriptor<com.exemplo.blog.DeleteBlogEntity, com.exemplo.blog.DeleteBlogEntity> getDeleteBlogMethod;
    if ((getDeleteBlogMethod = BlogServiceGrpc.getDeleteBlogMethod) == null) {
      synchronized (BlogServiceGrpc.class) {
        if ((getDeleteBlogMethod = BlogServiceGrpc.getDeleteBlogMethod) == null) {
          BlogServiceGrpc.getDeleteBlogMethod = getDeleteBlogMethod =
              io.grpc.MethodDescriptor.<com.exemplo.blog.DeleteBlogEntity, com.exemplo.blog.DeleteBlogEntity>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "DeleteBlog"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.exemplo.blog.DeleteBlogEntity.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.exemplo.blog.DeleteBlogEntity.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.exemplo.blog.ListBlogRequest,
      com.exemplo.blog.Blog> getListBlogMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListBlog",
      requestType = com.exemplo.blog.ListBlogRequest.class,
      responseType = com.exemplo.blog.Blog.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.exemplo.blog.ListBlogRequest,
      com.exemplo.blog.Blog> getListBlogMethod() {
    io.grpc.MethodDescriptor<com.exemplo.blog.ListBlogRequest, com.exemplo.blog.Blog> getListBlogMethod;
    if ((getListBlogMethod = BlogServiceGrpc.getListBlogMethod) == null) {
      synchronized (BlogServiceGrpc.class) {
        if ((getListBlogMethod = BlogServiceGrpc.getListBlogMethod) == null) {
          BlogServiceGrpc.getListBlogMethod = getListBlogMethod =
              io.grpc.MethodDescriptor.<com.exemplo.blog.ListBlogRequest, com.exemplo.blog.Blog>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListBlog"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.exemplo.blog.ListBlogRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.exemplo.blog.Blog.getDefaultInstance()))
  ...
  public static abstract class BlogServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void createBlog(com.exemplo.blog.Blog request,
        io.grpc.stub.StreamObserver<com.exemplo.blog.Blog> responseObserver) {
     ...
     * </pre>
     */
    public void readBlog(com.exemplo.blog.ReadBlogRequest request,
        io.grpc.stub.StreamObserver<com.exemplo.blog.Blog> responseObserver) {
    ...
    /**
     */
    public void updateBlog(com.exemplo.blog.Blog request,
        io.grpc.stub.StreamObserver<com.exemplo.blog.Blog> responseObserver) {
    ...
    /**
     */
    public void deleteBlog(com.exemplo.blog.DeleteBlogEntity request,
        io.grpc.stub.StreamObserver<com.exemplo.blog.DeleteBlogEntity> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getDeleteBlogMethod(), responseObserver);
    }

    /**
     */
    public void listBlog(com.exemplo.blog.ListBlogRequest request,
        io.grpc.stub.StreamObserver<com.exemplo.blog.Blog> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.exemplo.blog.ReadBlogRequest,
                com.exemplo.blog.Blog>(
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.exemplo.blog.DeleteBlogEntity,
                com.exemplo.blog.DeleteBlogEntity>(
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                com.exemplo.blog.ListBlogRequest,
                com.exemplo.blog.Blog>(
  ...
  public static final class BlogServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<BlogServiceBlockingStub> {
    ...
    /**
     */
    public com.exemplo.blog.Blog createBlog(com.exemplo.blog.Blog request) {
     ...
     * </pre>
     */
    public com.exemplo.blog.Blog readBlog(com.exemplo.blog.ReadBlogRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public com.exemplo.blog.Blog updateBlog(com.exemplo.blog.Blog request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public com.exemplo.blog.DeleteBlogEntity deleteBlog(com.exemplo.blog.DeleteBlogEntity request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public java.util.Iterator<com.exemplo.blog.Blog> listBlog(
        com.exemplo.blog.ListBlogRequest request) {
  ...
  public static final class BlogServiceFutureStub extends io.grpc.stub.AbstractFutureStub<BlogServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.exemplo.blog.Blog> createBlog(
        com.exemplo.blog.Blog request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.exemplo.blog.Blog> readBlog(
        com.exemplo.blog.ReadBlogRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.exemplo.blog.Blog> updateBlog(
        com.exemplo.blog.Blog request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.exemplo.blog.DeleteBlogEntity> deleteBlog(
        com.exemplo.blog.DeleteBlogEntity request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_BLOG:
          serviceImpl.createBlog((com.exemplo.blog.Blog) request,
              (io.grpc.stub.StreamObserver<com.exemplo.blog.Blog>) responseObserver);
          break;
        case METHODID_READ_BLOG:
          serviceImpl.readBlog((com.exemplo.blog.ReadBlogRequest) request,
              (io.grpc.stub.StreamObserver<com.exemplo.blog.Blog>) responseObserver);
          break;
        case METHODID_UPDATE_BLOG:
          serviceImpl.updateBlog((com.exemplo.blog.Blog) request,
              (io.grpc.stub.StreamObserver<com.exemplo.blog.Blog>) responseObserver);
          break;
        case METHODID_DELETE_BLOG:
          serviceImpl.deleteBlog((com.exemplo.blog.DeleteBlogEntity) request,
              (io.grpc.stub.StreamObserver<com.exemplo.blog.DeleteBlogEntity>) responseObserver);
          break;
        case METHODID_LIST_BLOG:
          serviceImpl.listBlog((com.exemplo.blog.ListBlogRequest) request,
              (io.grpc.stub.StreamObserver<com.exemplo.blog.Blog>) responseObserver);
          break;
        default:
  ...
  private static abstract class BlogServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.exemplo.blog.BlogOuterClass.getDescriptor();
    }
